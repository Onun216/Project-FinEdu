...
class BlogPage(models.Model):
    ...
    def get_absolute_url(self):
        if not self.is_published:
            return reverse('finedu_blog:blog-home')
        return reverse('finedu_blog:blog-page', args=(self.slug,))
...
class BlogPost(models.Model):
    ...
    content = models.TextField()
    cover = models.ImageField(upload_to='blog/%Y/%m/', blank=True, default='')
    cover_in_blog_post_content = models.BooleanField(
        default=True,
    ...
    def get_absolute_url(self):
        if not self.is_published:
            return reverse('finedu_blog:blog-home')
        return reverse('finedu_blog:blog-post', args=(self.slug,))
